                        ...
                        <form action="" class="signin-form" method="POST">
                            <ul>
                                <li class="input-field">
                                    ...
                                    <input class="signin-input" id="dangNhap_email" name="email" type="text" placeholder="Nhập email...">
                                </li>
                                <li>
                                    <strong>Mật khẩu<span class="mandatory-symbol">*</span></strong>
                                    <input class="signin-input" id="dangNhap_matkhau" name="matkhau" type="password" placeholder="Nhập mật khẩu...">
                                </li>
                            </ul>
